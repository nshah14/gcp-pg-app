...
public class PersonImpl implements PersonService {
	...
	public int insertDateOfBirth(Person person) throws SQLException {
		...
		int update = jdbcTemplate.update(INSERT_PERSON_SQL,
				new Object[] { person.getFirst_name(), person.getDateOfBirth() });
	...
	public int updateDateOfBirth(Person person) throws SQLException {
		...
		int insert = jdbcTemplate.update(UPDATE_PERSON_SQL,
				new Object[] { person.getDateOfBirth(), person.getFirst_name() });
	...
	public int getCount(String name) throws SQLException {
		...
		return Integer
				.parseInt((String) jdbcTemplate.queryForObject(SELECT_COUNT, new Object[] { name }, String.class));
